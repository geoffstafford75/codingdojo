...
class Ninja:
    db_name = 'dojos_and_ninjas_schema' # Make use of class variable to hold schema name
    ...
    def create_one(cls, data):
        ...
        query = "INSERT INTO ninjas (first_name, last_name, age, dojo_id) VALUES (%(first_name)s, %(last_name)s, %(age)s, %(dojo_id)s);" # Add query here - test them in MySQL workbench!
